...
description: Use for React or Next.js architecture and performance work, especially waterfalls, bundle size, rendering strategy, client-server boundaries, and production optimization.
---
...
| Deployment & DevOps     | `$release-deployment` |
