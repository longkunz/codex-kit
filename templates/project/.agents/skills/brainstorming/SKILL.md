---
name: brainstorming
description: Use for ideation, solution exploration, or clarifying ambiguous requirements before implementation. Do not use when the user wants direct execution without brainstorming.
---
