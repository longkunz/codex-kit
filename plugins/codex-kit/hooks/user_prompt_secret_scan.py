...
This plugin hook inspects stdin locally, prints only generic findings, and
never logs or sends prompt content anywhere.
"""
...
def main() -> int:
    ...
    print(
        f"Codex Kit plugin hook blocked this prompt because it appears to contain: {labels}. "
